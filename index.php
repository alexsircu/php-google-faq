...
$freqAsked = [
 ...
 <html lang="en" dir="ltr">
   ...
   <body>
      <?php foreach ($freqAsked as $section) {
      ?>
        <div class="question-container">
          <h2><?php echo $section["question"]; ?></h2>
          <?php foreach ($section["answer"] as $answer) {
          ?>
            <p> <?php echo $answer; ?></p>
          <?php } ?>
        </div>
